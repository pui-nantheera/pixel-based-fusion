...
img1_sum   = convn(img1, sum2_filter, 'valid');
img2_sum   = convn(img2, sum2_filter, 'valid');
img1_sq_sum = convn(img1_sq, sum2_filter, 'valid');
img2_sq_sum = convn(img2_sq, sum2_filter, 'valid');
img12_sum = convn(img12, sum2_filter, 'valid');
