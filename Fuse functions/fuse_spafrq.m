function FUSEDIMG = fuse_spafrq(ORIGIMGS,BLOCKSIZE,TH)
...
%   BLOCKSIZE is block size for spatial correlation (default = 8)
%   TH is a threshold for image selection (default = 1)
%
