function FUSEDIMG = fuse_lap(ORIGIMGS, LEVELS, HIGH, LOW)
%   fuse_lap - Image fusion with laplacian pyramid
%
%   FUSEDIMG = fuse_lap(ORIGIMGS, LEVELS, HIGH, LOW)
