function FUSEDIMG = fuse_con(ORIGIMGS, LEVELS, HIGH, LOW)
%   fuse_con - Image fusion with contrast pyramid
%
%   FUSEDIMG = fuse_con(ORIGIMGS, LEVELS, HIGH, LOW)
...
for i = 1:LEVELS 
  ...
  E(i) = {selc(ORIGIMGS./(MT+eps)-1, HIGH)};
