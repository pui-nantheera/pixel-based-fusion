function FUSEDIMG = fuse_fsd(ORIGIMGS, LEVELS, HIGH, LOW)
%   fuse_fsd - Image fusion with Filter-Substract-Decimate Laplacian Pyramid
%
%   FUSEDIMG = fuse_fsd(ORIGIMGS, LEVELS, HIGH, LOW)
